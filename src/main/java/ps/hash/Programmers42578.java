...
/**
 * 프로그래머스
 * - 코딩테스트 연습 - 해시 - 의상 (https://school.programmers.co.kr/learn/courses/30/lessons/42578)
 *
 * 문제 설명
...
public class Programmers42578 {
    ...
    public static int solution(final String[][] clothes) {
        ...
        for (String[] cloth : clothes) {
            ...
            clothesMap.put(type, clothesMap.getOrDefault(type, 0) + 1); // 종류별로 개수 카운팅
        }

        int result = 1;
        for (Integer count : clothesMap.values()) {
            result *= count + 1; // 해당 종류의 옷을 입지 않는 경우 +1
        }
